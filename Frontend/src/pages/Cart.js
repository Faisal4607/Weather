          ...
          <div className="col-12">
            ...
            >
              <div className="cart-col-1 gap-15 d-flex align-items-center">
                <div className="w-25">
                  <img
                    src="https://g-cdn.blinkco.io/ordering-system/55682/dish_image/1732209696.jpg"
                    className="img-fluid"
                    alt="Hardcoded Product"
                  />
                </div>
                <div className="w-75">
                  <p>Sunderkhani Mewa</p>
                </div>
              </div>
              <div className="cart-col-2">
                <h5 className="price">Rs. 1900</h5>
              </div>
              <div className="cart-col-3 d-flex align-items-center gap-15">
                <div>
                  <input
                    ...
                    type="number"
                    name="hardcoded-quantity"
                    min={1}
                    max={10}
                    value={1} // Hardcoded quantity
                    onChange={() => {}}
                    disabled
                  />
                </div>
